...
public class Reporting extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext)
	{
		...
		htmlReporter.loadXMLConfig("D:/Selenium_scripts/ecommorceProject/extent-config.xml");
		...
		htmlReporter.config().setDocumentTitle("Ecommorce Test Project"); // Tile of report
